...
def login_view(request):
	...
	return render(request, "authentication/login.html", {"form": form, 'title': 'authentication:login'})
...
class SendEmail(LoginRequiredMixin,View):
	...
	def post(self, request, *args, **kwargs):
		template = render_to_string('account/contact_message.html', {
		...
		return render(request, 'account/user_message_sent.html')
